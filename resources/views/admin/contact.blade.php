<html lang="en"><head>
    ...
    <title>Contact Us | Happy Hours</title>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" type="image/x-icon" href="{{asset('public/happyhours.png')}}">
...
<body>
    ...
    <section class="heading">
        <div>
            <img class="heading_img" src="{{asset('public/happyhours.png')}}" alt="heading_img">
        </div>
        <div>
    ...
    <footer class="container-fluid" id="footer">
        <div>
            <div class="heading">
                <div>
                    <img class="heading_img" src="{{asset('public/happyhours.png')}}" alt="smile_img">
                </div>
                <div>
                    <span>Happy <br>Hours</span>
                </div>
        ...
        <div class="footer_links">
            ...
            <span class="copyright-text">©
                ...
                </script> Hours Hours. All Rights Reserved.
            </span>
        </div>
    </footer> <!-- footer ends -->
